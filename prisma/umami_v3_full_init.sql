-- REINITIALISATION COMPLETE DU SCHEMA UMAMI V3
...
-- ==========================================
-- Migration: 02_report_schema_session_data
-- ==========================================
-- AlterTable
...
-- ==========================================
-- Migration: 03_metric_performance_index
-- ==========================================
-- CreateIndex
...
-- ==========================================
-- Migration: 09_update_hostname_region
-- ==========================================
-- AlterTable
...
-- ==========================================
-- Migration: 12_update_report_parameter
-- ==========================================
-- AlterTable
ALTER TABLE "report"
...
-- ==========================================
-- Migration: 14_add_link_and_pixel
-- ==========================================
-- AlterTable
...
-- ==========================================
-- Migration: 17_remove_duplicate_key
-- ==========================================
-- DropIndex
...
-- ==========================================
-- Migration: 19_add_session_replay
-- ==========================================
...
-- ==========================================
-- Migration: 23_update_session_data
-- ==========================================
...
-- ==========================================
-- Migration: 24_lowercase_username
-- ==========================================
...
-- ==========================================
-- Insertion du compte Administrateur par defaut
-- Identifiant: admin / Mot de passe: umami
-- ==========================================
INSERT INTO "user" ("user_id", "username", "password", "role", "two_factor_required")
VALUES ('4124c2fa-9626-4074-b52e-2e0618037fa9', 'admin', '$2b$10$uh.TC3bke4941gUj7lqBje.Z/e/qI5q/i6iW1kH02m9yP7B6hC/qG', 'admin', false)
